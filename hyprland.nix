  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      misc = {
        ...
        disable_hyprland_logo = true; # Set to true as per env.conf
      };
      ...
      # According to input.conf: gesture = 3, horizontal, workspace
      # In Nix settings, we can represent it as:
      ...
      bind = [
        ...
        "$mainMod, W, exec, grim -g \"$(slurp)\" - | wl-copy"
      ];
